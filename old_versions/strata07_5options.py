...
model.fc = nn.Linear(num_ftrs, 5)  # Output layer with 5 classes (left, right, up, down, none)
...
def predict_category(model, image_path, confidence_threshold=0.6):
    ...
    with torch.no_grad():
        ...
        if confidence.item() < confidence_threshold:
            ...
            predicted_directions = ["Down", "Left", "None", "Right", "Up"]
...
# predict_categories_for_test_folder(model, "combo/")
predict_categories_for_test_folder(model, "test/")
