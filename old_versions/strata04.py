...
##### 
##### TRY DIFFERENT MODEL BUT ACCURACY DID NOT IMPROVE
...
# Choose one of the EfficientNet models (e.g., 'efficientnet-b0')
...
model._fc = nn.Linear(num_ftrs, 4)    # Output layer with 4 classes (left, right, up, down)
